...
export default function SettingsScreen() {
  const { fontColor, fontColorName, themeMode, setFontColor, setThemeMode } =
    useTheme();
    ...
    <ScreenBackground>
      ...
      >
        <View style={styles.header}>
          <Text style={[styles.title, { color: fontColor }]}>Settings</Text>
          <Text style={[styles.subtitle, { color: secondary }]}>
            Personalize your Bible Journey
          </Text>
        </View>

        <Text style={[styles.section, { color: fontColor }]}>Reading</Text>
        <GlassCard intensity={45} style={styles.card}>
          ...
          >
            ...
            <View style={styles.textWrap}>
              <Text style={[styles.rowTitle, { color: fontColor }]}>
                Start date
              </Text>
          ...
          <HapticPressable onPress={confirmReset} style={styles.row}>
            ...
            <View style={styles.textWrap}>
              <Text style={[styles.rowTitle, { color: "#C94343" }]}>
                Reset journey
              </Text>
              <Text style={[styles.rowDesc, { color: secondary }]}>
        ...
        <Text style={[styles.section, { color: fontColor }]}>
          Notifications
        </Text>
        <GlassCard intensity={45} style={styles.card}>
          <View style={styles.row}>
            ...
            <Switch
              ...
              trackColor={{ false: "rgba(128,128,128,0.18)", true: fontColor }}
              thumbColor="#FFFFFF"
            />
          </View>
          <View style={styles.divider} />
        ...
        <Text style={[styles.section, { color: fontColor }]}>Appearance</Text>
        <GlassCard intensity={45} style={styles.card}>
          <Text style={[styles.label, { color: secondary }]}>DAY / NIGHT</Text>
          ...
          <View style={styles.colors}>
            {(Object.keys(FONT_COLORS) as FontColor[]).map((name) => {
              const selected = fontColorName === name;
              return (
                <HapticPressable
                  key={name}
                ...
                >
                  ...
                  />
                  <Text style={[styles.colorName, { color: fontColor }]}>
        ...
        <Text style={[styles.section, { color: fontColor }]}>Data</Text>
        <GlassCard intensity={45} style={styles.card}>
        ...
        <Text style={[styles.section, { color: fontColor }]}>About</Text>
        <GlassCard intensity={45} style={styles.card}>
          <HapticPressable
